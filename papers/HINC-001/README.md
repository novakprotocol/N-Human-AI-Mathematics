...
- a concrete classification of two Gerstenhaber endomorphism monoids;
...
- a human-led, AI-assisted mathematical-engineering case study.
...
| Specialist reader | `manuscript/MANUSCRIPT_INDEX.md` after source materialization |
...
| Dimension | Status |
|---|---|
| Self-contained manuscript | Complete candidate source in N-MathLab PR #406 |
