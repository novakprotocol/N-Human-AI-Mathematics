#!/usr/bin/env python3
"""Prepare the post-release ABF-001 integration branch without editing the website."""
...
def main() -> int:
    ...
    paper_status["state"] = "active_review"
    paper_status["claim_status"] = "candidate_theorem_and_exact_finite_classification_open_for_public_technical_review"
    paper_status["external_specialist_review"] = "requested_by_public_release"
    paper_status["historical_priority"] = "unestablished"
    paper_status["peer_review"] = "not_submitted"
    paper_status["release"] = {
        "public_authorized": True,
        "channel": "public_technical_review",
        "version": "0.1.0",
        "tag": args.tag,
        ...
        "professional_package_sha256": args.package_sha256,
            ...
            paper.update(
                {
                    ...
                    "internal_reproduction": "primary_bitset_c_small_universe_and_tamper_routes_pass",
    ...
    gate = {
        ...
        "gates": {
            "claim_boundary": {
                "status": "PASS",
                "evidence": ["papers/ABF-001/CLAIMS.md", "papers/ABF-001/manuscript/ABF-001_MANUSCRIPT.md"],
                "notes": "Candidate theorem and exact finite classification only; no security, peer-review, external-reproduction, full-formalization, or worldwide-priority claim.",
            },
            "proof": {
                "status": "PASS",
                "evidence": ["papers/ABF-001/PROOF_MAP.md", "papers/ABF-001/manuscript/ABF-001_MANUSCRIPT.md"],
                "universal_claims_have_complete_human_proofs": True,
                "finite_claims_exhaustively_verified_or_not_applicable": True,
            },
            "hostile_review": {
                "status": "PASS",
                "evidence": ["papers/ABF-001/review/FINAL_HOSTILE_REVIEW.md"],
                "blocking_findings_open": 0,
            },
            "prior_art_search": {
                "status": "PASS",
                "evidence": [
                    "papers/ABF-001/literature/SEARCH_PROTOCOL.md",
                    "papers/ABF-001/literature/PRIMARY_SOURCE_MAP.md",
                    "papers/ABF-001/literature/FINAL_DELTA_SEARCH.md",
                    "papers/ABF-001/literature/search-query-ledger-expanded.csv",
                ],
                "search_completed_to_declared_scope": True,
                "final_delta_search_completed": True,
                "final_delta_search_date": "2026-07-28",
                "historical_priority": "unestablished",
            },
            "independent_challenge": {
                "status": "PASS",
                "evidence": [
                    "papers/ABF-001/src/abf001_independent_bitset.py",
                    "papers/ABF-001/src/abf001_small_universe.c",
                    "papers/ABF-001/evidence/independent/abf001-independent-bitset.json",
                ],
                "structurally_independent_internal_route": True,
                "external_reproduction": "pending",
            },
            "clean_execution": {
                "status": "PASS",
                "evidence": [
                    "papers/ABF-001/qa/final-clean-execution-receipt.json",
                    "papers/ABF-001/evidence/receipts/small-universe-c-final.json",
                    "papers/ABF-001/evidence/receipts/tamper-control-final.json",
                ],
                "fresh_checkout_or_clean_copy": True,
                "completed_without_timeout": True,
                "partial_runs_accepted": False,
                "deterministic_receipt_present": True,
            },
            "provenance": {
                "status": "PASS",
                "evidence": [
                    "papers/ABF-001/SOURCE_SHA256SUMS.txt",
                    "papers/ABF-001/PUBLICATION_ARTIFACTS_0.1.0.md",
                    release_url,
                ],
                "source_identity_locked": True,
                "sha256_manifest_present": True,
                "versioned_tag_present": True,
                "release_record_present": True,
            },
            "owner_authorization": {
                "status": "PASS",
                "evidence": ["papers/ABF-001/OWNER_AUTHORIZATION.md"],
                "package_specific_authorization": True,
            },
        },
        "limitations": [
            "Historical priority remains unestablished.",
            "External specialist review and outside reproduction remain pending.",
            "Proof-assistant formalization is not completed and is not claimed.",
            "No full-width cryptographic security or insecurity conclusion is claimed.",
        ],
    }
...
**Evidence:** complete human proof, full 131,070-hyperplane enumeration, primary and integer/bitset implementations, strict-C 5,505,024-comparison small-universe control, tamper rejection, exact manifests, final hostile review with zero blockers, and a same-day systematic prior-art delta.
...
"""
    ...
    status += f"\n## ABF-001 release\n\n```text\ntag:                         {args.tag}\nmathematical source commit:  {args.mathematical_source_commit}\nrelease control commit:      {args.release_control_commit}\nprofessional package SHA-256:{args.package_sha256}\nsource package SHA-256:      {args.source_package_sha256}\nhistorical priority:         unestablished\nexternal reproduction:       pending\npeer reviewed:                false\n```\n"
    status_path.write_text(status, encoding="utf-8", newline="\n")

    print(json.dumps({"result": "PASS", "paper": "ABF-001", "destination": str(destination)}))
    return 0
